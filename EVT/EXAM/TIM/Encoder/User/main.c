 ...
 * 
 * @brief TIM2_UP_IRQHandler function handles the interrupt for TIM2 and updates the "circle" variable based
 * on the current count and auto-reload values of TIM2.
 */
...
/*********************************************************************
 * @fn TIM2_Encoder_Init
 * 
 * @brief function initializes the TIM2 timer as an encoder with specific settings.
 * 
 * @return none
 */
...
/*********************************************************************
 * @fn TIM3_EncoderSignalGenerator_Init
 * 
 * @brief The function initializes the TIM3 timer as an encoder signal generator with the specified prescaler,
 ...
 *        arr The "arr" parameter in the function TIM3_EncoderSignalGenerator_Init is used to set the
 ...
 *        ccr The "ccr" parameter in the function TIM3_EncoderSignalGenerator_Init is used to set the
 ...
 * @return none
 */
void TIM3_EncoderSignalGenerator_Init(uint16_t psc, uint16_t arr, uint16_t ccr)
{
...
int main(void)
{
    ...
    printf("Encoder TEST\r\n");
    TIM3_EncoderSignalGenerator_Init(SystemCoreClock / 1000000 - 1, 1000 - 1, 500);
    TIM2_Encoder_Init();
