...
/*
 *@Note
 *BOOT FLASH area 3328 Byte is used for User Flash usage tutorial:
 *The User FLASH extension for this routine is 62KByte+3328Byte.
 ...
 *3.The project can only be compiled after the use of WCH-LinkUtility V2.40 or
