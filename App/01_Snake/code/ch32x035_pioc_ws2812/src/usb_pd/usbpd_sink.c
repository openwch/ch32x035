...
void usbpd_sink_pdo_analyse(uint8_t* pdoData, pd_control_t* pdControl)
{
    ...
    { 
        ...
        else // fixed
        {
            ...
            // printf("[%d] voltage = %5d mV, current = %d mA\r\n",i, pdControl->cc_FixedSourceCap[i].Voltage,pdControl->cc_FixedSourceCap[i].Current);
        }
